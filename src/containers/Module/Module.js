      ...
      <React.Fragment>
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Button
            ...
            style={{ margin: " 10px" }}
            onClick={() =>
              this.setState({ ...this.state, activeModule: "dashboard" })
            }
          >
            Panel główny
          </Button>
          <Button
            ...
            style={{ margin: " 10px" }}
            onClick={() =>
              this.setState({ ...this.state, activeModule: "marks" })
            }
          >
            Oceny
          </Button>
          <Button
            ...
            style={{ margin: " 10px" }}
            onClick={() =>
              this.setState({ ...this.state, activeModule: "attendance" })
            }
          >
            Obecność
          </Button>
        ...
        {this.state.activeModule === "marks" && this.state.data !== null ? (
          <Marks
            ...
            markForms={this.state.data.markForms}
            finishedModule={this.state.data.endDate}
          />
        ) : null}
        {this.state.activeModule === "attendance" &&
        this.state.data !== null ? (
          <Attendance
            students={this.state.data.students}
            attendanceForm={this.state.data.attendanceForm}
            finishedModule={this.state.data.endDate}
          />
        ) : null}
      </React.Fragment>
