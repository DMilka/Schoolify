        ...
        <div style={{ flexGrow: 1, minWidth: '300px', minHeight: '200px' }}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={6} lg={6}>
              <TextField name={'value'} label="Ocena" margin="normal" value={this.state.formValues.value} />
            </Grid>
            <Grid item xs={12} md={6} lg={6}>
              <TextField name={'oldValue'} label="Stara ocena" margin="normal" value={this.state.formValues.oldValue} />
            </Grid>
          </Grid>
        </div>
